      ...
      <div id="content-cartes32" class="spa-content-section">
        ...
        <div id="content-belline" class="spa-content-section">
          ...
          <p style="font-style: italic; font-weight: bold; text-align: center">
            ...
            maîtrise des symboles ainsi qu'une sensibilité intuitive. Chaque
            carte peut apporter des éclairages sur des enjeux émotionnels,
            spirituels ou pratiques, et leur association peut mettre en lumière
            des dynamiques profondes de la situation examinée.
          </p>
          ...
          <p style="font-style: italic; font-weight: bold; text-align: center">
            D'après les dires de Belline, une consultante qui déménageait pour
            se retirer à la campagne lui aurait demandé de venir prendre chez
            elle des documents qui pourraient l'intéresser. Il s'y serait rendu
            et aurait découvert ainsi des jeux de cartes et un manuscrit qui
            auraient pu être daté de plus d'un siècle et auraient pu appartenir
            à l'un des prédécesseurs dans les lieux, le célèbre Mage Edmond qui
            en son temps aurait prédit entre autres choses le succès littéraire
            à Alexandre Dumas, etc...
          </p>

          <p style="font-style: italic; font-weight: bold; text-align: center">
            L'oracle de Belline est composé de cinquante-trois lames. Quatre
            d'entre elles sont indépendantes et les quarante-neuf lames
            restantes sont divisées en sept groupes de sept cartes, chaque
            groupe est sous l'influence d'une des sept planètes : La Lune, le
            Soleil, Mercure, Vénus, Mars, Jupiter et enfin Saturne.
          </p>

          <p style="font-style: italic; font-weight: bold; text-align: center">
            Si vous vous tirez les cartes, prenez en compte les cartes à la
            gauche et à la droite des lames et définissez le sens particulier de
            celles-ci En effet, si une ou plusieurs cartes négatives entourent
            la lame tirée cela signifie qu'un évènement positif ne verra pas le
            jour ou qu'il sera atténué voir repoussé Dans le cas contraire et si
            cette lame est entourée par une ou deux cartes bénéfiques alors vous
            pourrez voir naître un changement positif.
          </p>
